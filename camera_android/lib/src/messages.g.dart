...
class PlatformCapturedImageData {
  ...
  static PlatformCapturedImageData decode(Object result) {
    result as List<Object?>;
    return PlatformCapturedImageData(
...
class PlatformBoardOverlayData {
  ...
  double boardScreenWidth;

  double boardScreenHeight;
  ...
  static PlatformBoardOverlayData decode(Object result) {
    result as List<Object?>;
    return PlatformBoardOverlayData(
      boardImageBytes: result[0]! as Uint8List,
      boardScreenX: result[1]! as double,
      boardScreenY: result[2]! as double,
      boardScreenWidth: result[3]! as double,
      boardScreenHeight: result[4]! as double,
      previewWidth: result[5]! as double,
      previewHeight: result[6]! as double,
      devicePixelRatio: result[7]! as double,
      targetWidth: result[8]! as int,
      targetHeight: result[9]! as int,
      usePreviewFrame: (result.length > 10 && result[10] != null)
          ? result[10]! as bool
          : false,
    );
  }
...
class CameraApi {
  ...
  Future<PlatformCapturedImageData> captureToMemory() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_android.CameraApi.captureToMemory$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<PlatformCapturedImageData> captureToMemoryWithBoard(
      PlatformBoardOverlayData boardData) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_android.CameraApi.captureToMemoryWithBoard$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[boardData]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
