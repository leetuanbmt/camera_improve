...
class PlatformCapturedImageData {
  ...
  static PlatformCapturedImageData decode(Object result) {
    ...
    return PlatformCapturedImageData(
      bytes: (result[0] as List<Object?>?)!.cast<int>(),
...
class CameraApi {
  ...
  /// current orientation.
  Future<PlatformCapturedImageData> captureToMemory(
      PlatformCaptureOptions options) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_avfoundation.CameraApi.captureToMemory$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
