...
@interface FCPPlatformCapturedImageData ()
+ (FCPPlatformCapturedImageData *)fromList:(NSArray<id> *)list;
+ (nullable FCPPlatformCapturedImageData *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation FCPPlatformCapturedImageData
+ (instancetype)makeWithBytes:(NSArray<NSNumber *> *)bytes
    width:(NSInteger )width
    height:(NSInteger )height {
  FCPPlatformCapturedImageData* pigeonResult = [[FCPPlatformCapturedImageData alloc] init];
...
+ (nullable FCPPlatformCapturedImageData *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FCPPlatformCapturedImageData fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
...
+ (instancetype)makeWithBoardImageBytes:(FlutterStandardTypedData *)boardImageBytes
    ...
    boardScreenY:(double )boardScreenY
    boardScreenWidth:(double )boardScreenWidth
    boardScreenHeight:(double )boardScreenHeight
  ...
  pigeonResult.boardScreenY = boardScreenY;
  pigeonResult.boardScreenWidth = boardScreenWidth;
  pigeonResult.boardScreenHeight = boardScreenHeight;
  pigeonResult.previewWidth = previewWidth;
  pigeonResult.previewHeight = previewHeight;
...
+ (FCPPlatformBoardOverlayData *)fromList:(NSArray<id> *)list {
  FCPPlatformBoardOverlayData *pigeonResult = [[FCPPlatformBoardOverlayData alloc] init];
  pigeonResult.boardImageBytes = GetNullableObjectAtIndex(list, 0);
  pigeonResult.boardScreenX = [GetNullableObjectAtIndex(list, 1) doubleValue];
  pigeonResult.boardScreenY = [GetNullableObjectAtIndex(list, 2) doubleValue];
  pigeonResult.boardScreenWidth = [GetNullableObjectAtIndex(list, 3) doubleValue];
  pigeonResult.boardScreenHeight = [GetNullableObjectAtIndex(list, 4) doubleValue];
  pigeonResult.previewWidth = [GetNullableObjectAtIndex(list, 5) doubleValue];
  pigeonResult.previewHeight = [GetNullableObjectAtIndex(list, 6) doubleValue];
...
+ (nullable FCPPlatformBoardOverlayData *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FCPPlatformBoardOverlayData fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    self.boardImageBytes ?: [NSNull null],
    @(self.boardScreenX),
    @(self.boardScreenY),
    @(self.boardScreenWidth),
    @(self.boardScreenHeight),
    @(self.previewWidth),
    @(self.previewHeight),
...
void SetUpFCPCameraApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FCPCameraApi> *api, NSString *messageChannelSuffix) {
  ...
  /// current orientation.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation.CameraApi.captureToMemory", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FCPGetMessagesCodec()];
    if (api) {
