...
class AndroidCameraCameraX extends CameraPlatform {
  ...
  /// Captures a picture directly to memory as JPEG format with specified size.
  /// Returns the image data as bytes without saving to a temporary file.
  ///
  /// [width] and [height] specify the target size for the resized image.
  /// The image will be resized maintaining aspect ratio and compressed as JPEG.
  @override
  Future<CapturedImageData> captureToMemory(int cameraId) async {
    ...
    final PlatformCapturedImageData platformData =
        await imageCapture!.captureToMemory();
