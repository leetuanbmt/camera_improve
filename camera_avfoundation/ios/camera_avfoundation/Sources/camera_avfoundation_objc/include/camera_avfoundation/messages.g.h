...
@interface FCPPlatformCapturedImageData : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)makeWithBytes:(NSArray<NSNumber *> *)bytes
    width:(NSInteger )width
    height:(NSInteger )height;
@property(nonatomic, copy) NSArray<NSNumber *> * bytes;
...
@property(nonatomic, assign) double  boardScreenWidth;
@property(nonatomic, assign) double  boardScreenHeight;
